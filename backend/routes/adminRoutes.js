...
import { 
    ...
    unbanAllUsers,
    updateOrderStatus,
    // ✅ পরিবর্তন ১: 'getAdminStats' এর পরিবর্তে 'getDashboardSummary' ইম্পোর্ট করা হয়েছে
    getDashboardSummary 
} from '../controllers/adminController.js';
import { protect, admin } from '../middleware/authMiddleware.js';
...
// GET /api/admin/stats -> ড্যাশবোর্ডের পরিসংখ্যান দেখুন
router.route('/stats')
    // ✅ পরিবর্তন ২: এখানে getAdminStats এর পরিবর্তে getDashboardSummary ব্যবহার করা হচ্ছে
