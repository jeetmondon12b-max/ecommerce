...
import { Swiper, SwiperSlide } from 'swiper/react';
// ✅ পরিবর্তন: 'Navigation' মডিউলটি এখান থেকে সরানো হয়েছে
...
const ProductSection = ({ title, categorySlug }) => {
    ...
    const renderContent = () => {
        ...
        return (
            <Swiper
                // ✅ পরিবর্তন: 'Navigation' মডিউলটি এখানেও সরানো হয়েছে
                modules={[Autoplay]}
                spaceBetween={16}
                slidesPerView={2}
                loop={products.length > 5}
                ...
                // ✅ ফিক্স: বাটন লুকানোর জন্য navigation={true} কে false করা হয়েছে
                navigation={false}
